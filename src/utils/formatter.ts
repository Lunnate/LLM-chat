...
export function formatMessage(text: string) {
  ...
  renderer.code = ({
    ...
    return `
    <div class="flex items-center justify-between bg-neutral-900 rounded-t-lg pl-2 pb-1 border-b-4 border-neutral-800 mt-2">
      <p class="text-white font-semibold">${lang}</p>
      <svg width="18px" height="18px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="cursor-pointer mr-2 mt-1">
